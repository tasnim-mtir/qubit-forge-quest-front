            ...
            <div className="flex flex-col gap-4">
                ...
                <>
                  ...
                  {isAdmin && pendingCount && pendingCount.pendingRequests > 0 && (
                    <button
                      ...
                      className="text-left px-4 py-2 rounded-lg hover:bg-yellow-500/10 text-yellow-300 flex items-center gap-2 relative"
                    >
                      <Clock className="w-4 h-4" />
                      Pending Requests
                      <span className="ml-auto bg-yellow-500 text-xs text-slate-900 font-bold px-2 py-1 rounded-full">
              ...
              {isAdmin && (
                <Button 
                  ...
                  className="bg-gradient-to-r from-red-600 to-red-700 text-white font-display hover:opacity-90 w-full"
                >
              ...
              {isCreator && (
                <Button 
                  ...
                  className="bg-gradient-to-r from-primary to-accent text-background font-display hover:opacity-90 w-full"
                >
              ...
              {isInvestor && (
                <Button 
                  ...
                  className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-display hover:opacity-90 w-full"
                >
                  <Gauge className="w-4 h-4 mr-2" />
                  Dashboard
                </Button>
              ...
              <Button 
                onClick={handleSignOut}
                variant="outline"
                className="border-primary/50 hover:bg-primary/10 font-display w-full mt-4"
              >
